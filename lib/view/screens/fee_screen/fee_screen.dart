...
class FeesScreen extends StatefulWidget {
  final List<FeesImage> feesImages;
  final String feesImagePath;

  const FeesScreen({
    super.key,
    required this.feesImages,
...
class _FeesScreenState extends State<FeesScreen> {
  ...
  String getFullImageUrl(String imageName) {
    return '${widget.feesImagePath}$imageName';
  }

  Future<void> downloadImage(String imageUrl) async {
    try {
      String downloadPath =
          '/storage/emulated/0/Download/college_fees_${DateTime.now().millisecondsSinceEpoch}.jpg';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(title: 'Fees Structure'),
      body: widget.feesImages.isEmpty
          ? const Center(
              child: Text(
          ...
          : Padding(
              ...
              child: GridView.builder(
                ...
                itemCount: widget.feesImages.length,
                itemBuilder: (context, index) {
                  final imageUrl = getFullImageUrl(widget.feesImages[index].fees);
